...
<body data-filter="all">
  <div class="wrap">
    <header>
      ${MARK}
      <div><h1>promptproof</h1><div class="tag">test report</div></div>
    </header>
    ${renderBanner(diff)}
    ...
    ${suites}
    <footer>Generated by <a href="https://github.com/rxNxkolai/promptproof">promptproof</a> · unit tests for your LLM prompts</footer>
  </div>
  <script>
